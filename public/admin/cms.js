...
/******/ 	const __webpack_modules__ = ({
  ...
  \*************************************************************************/
    /***/ function (module, __unused_webpack_exports, __webpack_require__) {
      ...
      const htmlEntities = __webpack_require__(/*! html-entities */ './node_modules/@gatsbyjs/webpack-hot-middleware/node_modules/html-entities/lib/index.js')
  ...
  \*****************************************************************/
    /***/ function (module, __unused_webpack_exports, __webpack_require__) {
      ...
      if (false) { let overrides, URLSearchParams }
      ...
      function createReporter () {
        const strip = __webpack_require__(/*! strip-ansi */ './node_modules/strip-ansi/index.js')
      ...
      const processUpdate = __webpack_require__(/*! ./process-update */ './node_modules/@gatsbyjs/webpack-hot-middleware/process-update.js')
  ...
  \***********************************************************************************************/
    /***/ function (__unused_webpack_module, exports, __webpack_require__) {
      ...
      const named_references_1 = __webpack_require__(/*! ./named-references */ './node_modules/@gatsbyjs/webpack-hot-middleware/node_modules/html-entities/lib/named-references.js')
      const numeric_unicode_map_1 = __webpack_require__(/*! ./numeric-unicode-map */ './node_modules/@gatsbyjs/webpack-hot-middleware/node_modules/html-entities/lib/numeric-unicode-map.js')
      const surrogate_pairs_1 = __webpack_require__(/*! ./surrogate-pairs */ './node_modules/@gatsbyjs/webpack-hot-middleware/node_modules/html-entities/lib/surrogate-pairs.js')
      const allNamedReferences = __assign(__assign({}, named_references_1.namedReferences), { all: named_references_1.namedReferences.html5 })
      const encodeRegExps = {
        specialChars: /[<>'"&]/g,
        nonAscii: /(?:[<>'"&\u0080-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])/g,
      ...
      function encode (text, _a) {
        var _b = _a === void 0 ? defaultEncodeOptions : _a; var _c = _b.mode; const mode = _c === void 0 ? 'specialChars' : _c; var _d = _b.numeric; const numeric = _d === void 0 ? 'decimal' : _d; var _e = _b.level; const level = _e === void 0 ? 'all' : _e
        if (!text) {
          return ''
        }
        ...
        if (_b) {
          ...
          do {
            ...
            var _e = _b[0]
            let result_1 = references[_e]
            if (!result_1) {
              const code_1 = _e.length > 1 ? surrogate_pairs_1.getCodePoint(_e, 0) : _e.charCodeAt(0)
      ...
      const decodeRegExps = __assign(__assign({}, baseDecodeRegExps), { all: baseDecodeRegExps.html5 })
      ...
      function decodeEntity (entity, _a) {
        var _b = (_a === void 0 ? defaultDecodeEntityOptions : _a).level; const level = _b === void 0 ? 'all' : _b
        if (!entity) {
          return ''
        }
        var _b = entity
      ...
      function decode (text, _a) {
        const decodeSecondChar_1 = _a === void 0 ? defaultDecodeOptions : _a; const decodeCode_1 = decodeSecondChar_1.level; const level = decodeCode_1 === void 0 ? 'all' : decodeCode_1; const _b = decodeSecondChar_1.scope; const scope = _b === void 0 ? level === 'xml' ? 'strict' : 'body' : _b
        if (!text) {
          return ''
        }
        ...
        let replaceMatch_1 = decodeRegExp.exec(text)
        let replaceResult_1
        if (replaceMatch_1) {
          replaceResult_1 = ''
          ...
          do {
            ...
            let decodeResult_1 = replaceInput_1
            const decodeEntityLastChar_2 = replaceInput_1[replaceInput_1.length - 1]
            if (isAttribute &&
              ...
              const decodeResultByReference_2 = references[replaceInput_1]
              if (decodeResultByReference_2) {
                decodeResult_1 = decodeResultByReference_2
              } else if (replaceInput_1[0] === '&' && replaceInput_1[1] === '#') {
                const decodeSecondChar_2 = replaceInput_1[2]
 ...
 */
        ...
        function check () {
          const cb = function (err, updatedModules) {
            ...
            const applyCallback = function (applyErr, renewedModules) {
              if (applyErr) { handleError(applyErr); return }
  ...
  \***************************************************************************************/
    /***/ function (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
      const __resourceQuery = ''
      /* provided dependency */ const __react_refresh_error_overlay__ = __webpack_require__(/*! ./node_modules/gatsby/dist/utils/fast-refresh-module.js */ './node_modules/gatsby/dist/utils/fast-refresh-module.js')
      /* provided dependency */ const __react_refresh_init_socket__ = __webpack_require__(/*! ./node_modules/@pmmmwh/react-refresh-webpack-plugin/sockets/WHMEventSource.js */ './node_modules/@pmmmwh/react-refresh-webpack-plugin/sockets/WHMEventSource.js')
 ...
 */
      function createRejectionHandler (callback) {
        return function rejectionHandler (event) {
          if (!event?.reason) {
            callback(new Error('Unknown')); return
          }
          if (event.reason instanceof Error) {
            callback(event.reason); return
          }
          // A non-error was rejected, we don't have a trace :(
          // Look in your browser's devtools for more information
          callback(new Error(event.reason))
        }
      }
 ...
 */
  ...
  \**************************************************/
    /***/ function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ const mitt__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mitt */ './node_modules/mitt/dist/mitt.es.js')
  ...
  \****************************************************************/
    /***/ function (module, __unused_webpack_exports, __webpack_require__) {
      ...
      const _netlifyIdentityWidget = _interopRequireDefault(__webpack_require__(/*! netlify-identity-widget */ 'netlify-identity-widget'))
      /* global CMS_PUBLIC_PATH */

      window.netlifyIdentity = _netlifyIdentityWidget.default

      const addLoginListener = function addLoginListener () {
  ...
  \*******************************************************/
    /***/ function (module, __unused_webpack_exports, __webpack_require__) {
      ...
      const _netlifyCmsApp = _interopRequireDefault(__webpack_require__(/*! netlify-cms-app */ 'netlify-cms-app'))

      const _emitter = _interopRequireDefault(__webpack_require__(/*! gatsby/cache-dir/emitter */ './node_modules/gatsby/cache-dir/emitter.js')) // set global variables required by Gatsby's components
...
typeof WeakMap === 'function' ? new WeakMap() : null
  ...
  /******/ 	!(function () {
    /******/ 		__webpack_require__.h = function () { return 'e144155aaa37d7a18592' }
    /******/ 	}())
  /******/
  ...
  /******/ 	!(function () {
    /******/ 		const inProgress = {}
    /******/ 		const dataWebpackPrefix = 'gatsby-starter-default:'
    ...
    /******/ 		__webpack_require__.l = function (url, done, key, chunkId) {
      ...
      /******/ 			const onScriptComplete = function (prev, event) {
        ...
        /******/ 				doneFns?.forEach(function (fn) { return fn(event) })
...
/******/ 			}
    ...
    /******/ 		function waitForBlockingPromises (fn) {
      ...
      /******/ 		}
    /******/
    /******/ 		async function hotCheck (applyOnUpdate) {
      /******/ 			if (currentStatus !== 'idle') {
        /******/ 				throw new Error('check() is only allowed in idle status')
        /******/ 			}
      /******/ 			return await setStatus('check')
      /******/ 				.then(__webpack_require__.hmrM)
      /******/ 				.then(async function (update) {
          /******/ 					if (!update) {
            /******/ 						return await setStatus(applyInvalidatedModules() ? 'ready' : 'idle').then(
              /******/ 							function () {
                /******/ 								return null
                /******/ 							}
              /******/)
            /******/ 					}
          /******/
          /******/ 					return await setStatus('prepare').then(async function () {
  ...
  /******/ 	!(function () {
    /******/ 		const createStylesheet = function (chunkId, fullhref, resolve, reject) {
      /******/ 			const linkTag = document.createElement('link')
      /******/
      /******/ 			linkTag.rel = 'stylesheet'
      /******/ 			linkTag.type = 'text/css'
      /******/ 			const onLinkComplete = function (event) {
        /******/ 				// avoid mem leaks.
      ...
      /******/ 			return linkTag
      /******/ 		}
    /******/ 		const findStylesheet = function (href, fullhref) {
    ...
    /******/ 		const oldTags = []
    /******/ 		const newTags = []
    /******/ 		const applyHandler = function (options) {
      /******/ 			return {
        dispose: function () {
  ...
  /******/ 	!(function () {
    ...
    /******/ 		async function loadUpdateChunk (chunkId, updatedModulesList) {
      ...
      /******/ 			return await new Promise(function (resolve, reject) {
        ...
        /******/ 				const loadingEnded = function (event) {
...
/******/ 					}
            ...
            /******/ 						if (__webpack_require__.o(outdatedDependencies, outdatedModuleId)) {
              ...
              /******/ 							if (module) {
                ...
                /******/ 								for (let j = 0; j < moduleOutdatedDependencies.length; j++) {
                  ...
                  /******/ 									if (acceptCallback) {
                    /******/ 										if (callbacks.includes(acceptCallback)) continue
    ...
    /******/ 		__webpack_require__.hmrC.jsonp = function (
      ...
      /******/ 		}
    /******/
    /******/ 		__webpack_require__.hmrM = async function () {
      /******/ 			if (typeof fetch === 'undefined') throw new Error('No browser support: need fetch API')
      /******/ 			return await fetch(__webpack_require__.p + __webpack_require__.hmrF()).then(async function (response) {
  ...
  /******/ 	const __webpack_exports__ = __webpack_require__('./node_modules/gatsby-plugin-netlify-cms/cms-identity.js')
/******/
/******/ })()
