  ...
  return (
    <ol className="relative my-12 md:me-12">
      {data.map((item: TimelineDataType) => {
        return (
          <li className='base-card p-12 mb-12'>
            <div className='education-detail' style={{
              ...
              {item.isLatest
                ? (
                  <Badge className='bg-indigo-50 text-lg text-[#646cea] mb-6 me-3'>
                    Latest
                  </Badge>
                  )
                : null}
              ...
              {item.data.map((job: TimelineDataArrayType) => {
                return (
                  <>
                    {job.jobtitle && (
                      <time data-aos="animation-scale-y" data-aos-duration="500" className="mb-2 block font-normal leading-6 text-xl">
                        {job.jobtitle}
                      </time>
                    )}
                    {job.time && (
