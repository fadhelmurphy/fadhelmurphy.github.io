...
<hr />
      ...
      <div class="grid grid-cols-2 items-start gap-x-20 my-5">
  # Registration
...
Terus lu masukin deh tuh nama library lu, misalkan disini gue namanya <b class="text-teal-500">@mamatgarem-ui</b>.
