...
# Diagram
  ...
  Jadi, pada tutorial ini memungkinkan beberapa component dalam satu repo dengan version pada setiap component berbeda,
  tetapi dengan 1 node_modules yg sama dan dapat dengan mudah melakukan sharing code antar component tanpa harus berpindah repository (Monorepo).
...
![membuat component library](./img/input-organization.png)
  </center>
...
<div class="dotsep" />
  ...
  ![membuat component library](./img/skip-organization.png)
  </center>
...
![membuat component library](./img/result-organization.png)
  </center>
...
![membuat component library](./img/access-token-npmrc.png)
  </center>
...
![membuat component library](./img/generate-new-token-npmrc.png)
  </center>
...
![membuat component library](./img/new-access-token-npmrc.png)
  </center>
...
![membuat component library](./img/result-npmrc.png)
  </center>
...
Dibawah ini ada analogi nya si rollup itu ngapain.
 ...
 ![membuat component library](./img/rollup-component.png)
  </center>
...
<p><b>Notes: pada step ini abaikan folder dist, karena folder dist akan digenerate otomatis pada step cara build component.</b></p>
...
Pertama, pastiin lu tau lokasi folder project UI Component Library lu dan Contoh project (React.js).
  ...
  <div class="w-[20vw]">
   ...
   ![import local](./img/current-dir-import-local.png)
...
Contoh, disini mangkodir-ui (UI Library Component) dan contoh-project-nextjs (React.js) dengan posisi sejajar 
dalam satu folder yang sama.
  ...
  <div class="w-[40vw]">
   ...
   ![consume package json](./img/package-json-import-local.png)
...
- <b class="text-teal-500">@fdhl/button</b>: nama ini bisa kalian ubah sesuai keinginan.
- <b class="text-teal-500">../mangkodir-ui/packages/button_test</b>: ini lokasi folder project UI Component Library kalian.
...
Hasilnya akan tampil seperti gambar dibawah ini.
  ...
  <div class="w-[40vw]">
   ...
   ![consume package json](./img/result-import-local.png)
