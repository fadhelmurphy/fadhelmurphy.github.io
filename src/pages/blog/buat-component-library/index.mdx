...
# Diagram
  ...
  Jadi kita akan membuat semua componet dalam satu repo (Monorepo) yang menggunakan 1 node_modules dan dapat melakukan sharing antar component.
