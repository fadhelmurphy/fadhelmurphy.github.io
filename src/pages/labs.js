...
const Works = ({ location }) => {
  ...
  return (
    <>
      <SEO title="Labs" />
      <Menu location={location} position="fixed-top" />
      <Container className="align-self-center py-5">
        ...
        >
          ...
          >
            <h1
              className="word word-project text-center"
              style={{
                fontWeight: "600",
                color: "#d7eee1",
                letterSpacing: "2rem",
          ...
          return (
            <Row className="justify-content-lg-between my-5 py-5 flex-column-reverse flex-lg-row">
              <Col
                ...
                data-aos="fade-up"
              >
                <h1 className="text-capitalize" style={{ fontWeight: "800" }}>
                  {el.judul}
                </h1>
                <p>{el.desc}</p>
                <a
