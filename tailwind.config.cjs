      ...
      matchUtilities(
        ...
        },
        {
          values: flattenColorPalette(Object.assign(theme("backgroundImage", {}), {
            ...
            "edu-md": "radial-gradient(65% 110% at 87% 65%, #ff47bd -30%, rgba(253, 119, 2, 0.15) 15%, rgba(255,255,255,0) 25%)",
            "edu-lg": "radial-gradient(188% 222% at 116% 50%, #ff47bd 0%, rgba(253, 119, 2, 0.2) 13%, rgba(255,255,255,0) 19%)",
            "timeline": "radial-gradient(circle at 100% 11%, rgba(96,165,250,0.7) 0%, rgba(165,243,252,0.5) 2%, rgba(255,255,255,0) 4%)",
